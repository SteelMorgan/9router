...
export function openaiResponsesToOpenAIRequest(model, body, stream, credentials) {
  ...
  // Hosted tools (e.g. web_search, computer_use) have no name and are passed through
  // as-is so downstream translators can map them to provider-native equivalents.
